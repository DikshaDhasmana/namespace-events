...
-- Add event_id and team_id to projects table for hackathon projects
...
-- Create project_members table for ownership and contributor tracking
...
CREATE POLICY "Owners can update member roles (except other owners)"
  ON public.project_members
  FOR UPDATE
  USING (
    EXISTS (
